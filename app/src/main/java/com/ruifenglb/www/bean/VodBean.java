...
public class VodBean implements BannerData, Vod, Parcelable,Cloneable {
...
//    }
    ...
    public void setVodscore_all(String vod_score_all) {
        this.vod_score_all = vod_score_all;
    }

    public String getVod_score_num() {
        return vod_score_num;
    }

    public void setVod_score_num(String vod_score_num) {
        this.vod_score_num = vod_score_num;
    }

    public int getVod_points_play() { return vod_points_play; }

    public void setVod_points_play(int vod_points_play) { this.vod_points_play = vod_points_play;}
...
//    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.vod_score_all);
        dest.writeString(this.vod_score_num);
    ...
    protected VodBean(Parcel in) {
        ...
        this.vod_score_all = in.readString();
        this.vod_score_num = in.readString();
    ...
    @Override
    public VodBean clone()  {
        try {
            return (VodBean)super.clone();
