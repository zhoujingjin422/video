...
import com.ruifenglb.www.ui.widget.X5WebView;


public class X5WebActivity extends BaseActivity {


    @BindView(R.id.iv_home_top_bg1)
    ImageView iv_home_top_bg1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Data.getQQ() == "暗夜紫")  {
            iv_home_top_bg1.setBackgroundResource(R.color.xkh);

        }
        if (Data.getQQ() == "原始蓝")  {

            iv_home_top_bg1.setBackgroundResource(R.color.ls);
        }
