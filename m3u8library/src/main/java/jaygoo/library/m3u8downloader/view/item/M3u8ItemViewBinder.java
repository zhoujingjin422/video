...
public class M3u8ItemViewBinder extends ItemViewBinder<M3u8Item, M3u8ItemViewBinder.ViewHolder> {
    ...
    private List<M3u8Item> selectList = new ArrayList<>();
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, @NonNull final M3u8Item m3u8Item) {
        ...
        if (m3u8Item.getItemListener() != null) {
            ...
            if (isSelectAll) {
                ...
                selectList.add(m3u8Item);
                if (m3u8Item.getItemListener() != null) {
                    m3u8Item.getItemListener().onSelect(selectList.size());
                }
            } else {
    ...
    public List<M3u8Item> getSelectItem() {
        return selectList;
    }

    public void deleteSlectItem(M3u8Item item) {
