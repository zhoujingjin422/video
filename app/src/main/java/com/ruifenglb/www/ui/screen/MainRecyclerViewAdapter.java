...
public class MainRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public void setHeader(Titles list0,Titles list1, Titles list2, Titles list3, Titles list4) {
        list00 = list0;
        list01 = list1;
        list02 = list2;
        list03 = list3;
        ...
        rv0 = (RecyclerView) view.findViewById(R.id.rv_0);
        ...
        if(list0.getTitles()==null||list0.getTitles().size()==0){
            rv0.setVisibility(View.GONE);
        }

        centerLm0 = new CenterLayoutManager(getContext(), LinearLayoutManager.HORIZONTAL, false);
        ...
        rv0.setLayoutManager(centerLm0);
        rv1.setLayoutManager(centerLm1);
        rv2.setLayoutManager(centerLm2);
        rv3.setLayoutManager(centerLm3);
        rv4.setLayoutManager(centerLm4);

        adapter0 = new MultiTypeAdapter();
        titleItemViewBinder0 = new TitleItemViewBinder();
        titleItemViewBinder0.setData(list0,true);
        titleItemViewBinder0.setBaseItemClickListener(new BaseItemClickListener2() {
            @Override
            public void onClickItem(View view, Object item, int positon) {
//                rv1.smoothScrollToPosition(positon);
                list0.setCurTitle(list0.getTitles().get(positon));
                centerLm0.smoothScrollToPosition(rv0, new RecyclerView.State(), positon);
                adapter0.notifyDataSetChanged();
            }
        });
//        titleItemViewBinder1.setLayoutManager(rv1, centerLm1);
        adapter0.register(Title.class, titleItemViewBinder0);
        if(list0.getTitles()!=null){
            adapter0.setItems(list0.getTitles());
        }
        rv0.setNestedScrollingEnabled(false);
        rv0.setAdapter(adapter0);


        adapter1 = new MultiTypeAdapter();
        titleItemViewBinder1 = new TitleItemViewBinder();
        titleItemViewBinder1.setData(list1,false);
...
//                rv2.smoothScrollToPosition(positon);
        ...
        titleItemViewBinder2.setData(list2,false);
        ...
        titleItemViewBinder3.setData(list3,false);
...
//                rv3.smoothScrollToPosition(positon);
        ...
        titleItemViewBinder4.setData(list4,false);
...
//                rv4.smoothScrollToPosition(positon);
        ...
        centerLm0.smoothScrollToPosition(rv0, new RecyclerView.State(), list1.getCurPos());
   ...
   holder.up_title.setTextColor(ColorUtils.getColor(R.color.white));
    ...
    public void onClick(View v) {
        ...
        if (o != null) {
            if (o instanceof Vod) {
                Vod vod = (Vod) o;
                PlayActivity.startByVod(vod, (Activity) v.getContext());
            }
        }
    }
